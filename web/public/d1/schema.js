export const SCHEMA = [
  ...
  "CREATE TABLE IF NOT EXISTS dashboard_opportunity_history(signal_date TEXT NOT NULL,id TEXT NOT NULL,payload TEXT NOT NULL CHECK(json_valid(payload)),PRIMARY KEY(signal_date,id))",
